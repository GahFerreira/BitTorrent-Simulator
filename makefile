...
all: main.o usuario.o info_usuario.o info_compartilhada.o lista_mensagem.o lista_encadeada.o
	$(CXX) $(CXX_FLAGS_ALL) main.o usuario.o info_usuario.o info_compartilhada.o lista_mensagem.o lista_encadeada.o -o simulador.exe
